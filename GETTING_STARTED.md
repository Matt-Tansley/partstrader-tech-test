...
- [ ] Use stricter type checking. For this exercise, I am not using strict type checking and am using this rule in `eslint.config.js`: `"@typescript-eslint/no-explicit-any": "off"`
...
- [ ] Possibly using a test data utils functions file. For example, there could be a function that returns an object that contains all the necessary data for a form.
